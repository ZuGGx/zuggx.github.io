...
$(function(){$("#form").submit(function(){var i=$(this);return $.ajax({type:"POST",url:"/mail.php",data:i.serialize()}).done(function(){i.find(".success").addClass("active"),setTimeout(function(){i.find(".success").removeClass("active"),i.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".popup-with-move-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$(".tab_content").each(function(){$(this).find(".tab_item").not(":first").hide()}),$(".tabs").each(function(){$(this).find(".tab").first().addClass("active")}),$(".wrapper .tab").click(function(){$(this).closest(".wrapper").find(".tab").removeClass("active").eq($(this).index()).addClass("active"),$(this).closest(".wrapper").find(".tab_item").hide().eq($(this).index()).fadeIn()}),$(".accordion_wrapper>.accordion_content").not(":first").hide(),$(".accordion_wrapper>.accordion_item").click(function(){var i=$(this).next(),e=$(this).closest(".accordion_wrapper");i.is(":visible")?(i.slideUp("fast"),i.prev().find(".fa").removeClass().addClass("fa fa-plus-circle")):(e.find(">.accordion_content").slideUp("fast"),e.find(".fa").removeClass().addClass("fa fa-plus-circle"),i.prev().find(".fa").removeClass().addClass("fa fa-minus-circle"),i.slideDown("fast"))}),$("#slider_container").owlCarousel({items:1}),$(".form-sel").selectric()});
...
$(function(){function a(){$("header").css("min-height",$(window).height())}function i(){o=new ymaps.Map("map",{center:[55.49119539,54.84438651],zoom:16}),o.behaviors.disable(["scrollZoom"]),t=new ymaps.Placemark([55.49109793,54.84462254],{hintContent:"Компания Дю Пласт"}),o.geoObjects.add(t)}a(),$(window).resize(function(){a()}),$("#carousel_access").owlCarousel({loop:!0,nav:!0,slideBy:3,navText:["<i class='fa fa-angle-left'></i>","<i class='fa fa-angle-right'></i>"],responsive:{0:{items:1},480:{items:1},600:{items:2},768:{items:3},992:{items:3},1200:{items:3}}}),$("#service_carousel").owlCarousel({loop:!0,items:1,autoplay:!0,autoplayTimeout:3e3}),$(document).ready(function(){$(".popup-gallery").magnificPopup({mainClass:"mfp-zoom-in",delegate:"a",type:"image",tLoading:"",gallery:{enabled:!0},removalDelay:300,callbacks:{beforeChange:function(){this.items[0].src=this.items[0].src+"?="+Math.random()},open:function(){$.magnificPopup.instance.next=function(){var e=this;e.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.next.call(e)},120)},$.magnificPopup.instance.prev=function(){var e=this;e.wrap.removeClass("mfp-image-loaded"),setTimeout(function(){$.magnificPopup.proto.prev.call(e)},120)}},imageLoadComplete:function(){var e=this;setTimeout(function(){e.wrap.addClass("mfp-image-loaded")},16)}}})}),$(".form-sel").selectric(),$(".primary-nav a").mPageScroll2id(),$("body").append('<div class="top"><i class="fa fa-angle-double-up">'),$("body").on("click",".top",function(){$("html, body").animate({scrollTop:0},"slow")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".nav-toggle").on("click",function(){return $(this).toggleClass("close-nav"),$(".navigation").toggleClass("open"),!1}),$(".navigation").find("a").on("click",function(){$(".nav-toggle").toggleClass("close-nav"),$(".navigation").toggleClass("open")}),$(".popup-with-move-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$('form input[type="name"], form input[type="phone"], form textarea').val(""),$(".form-callback-small").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){e.find(".success").addClass("active"),setTimeout(function(){e.find(".success").removeClass("active"),e.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".form-callback-small").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"/mail.php",data:e.serialize()}).done(function(){e.find(".success").addClass("active"),setTimeout(function(){e.find(".success").removeClass("active"),e.trigger("reset"),$.magnificPopup.close()},3e3)}),!1}),$(".form-callback").submit(function(){var a=$(this);return e.preventDefault,$.ajax({type:"POST",url:"mail.php",data:$(this).serialize()}).done(function(){alert("Спасибо за заявку!"),setTimeout(function(){$.magnificPopup.instance.close(),a.trigger("reset")},1e3)}),!1}),ymaps.ready(i);var o,o,t});